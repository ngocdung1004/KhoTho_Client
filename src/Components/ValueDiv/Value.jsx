...
const Value = () => {
  return (
    <div className='mb-[4rem] mt-[6rem]'>
      <h1 className='text-textColor text-[25px] py-[2rem] pb-[3rem] font-bold w-[400px] block'  > Giá trị giữ chúng ta trung thực và có trách nhiệm </h1>
      ...
      <div className="grid gap-[10rem] grid-cols-3 items-center">
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#E7F5FF] p-[1.5rem]">
          <div className="flex items-center gap-3">
            ...
            <p className='text-[13px] text-textColor opacity-[0.7] py-[1rem] font-semibold '> Things being made beautifuk simple are at the heart of Everything we do.</p>
        </div>
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#f7edf5] p-[1.5rem]">
          <div className="flex items-center gap-3">
            ...
            <p className='text-[13px] text-textColor opacity-[0.7] py-[1rem] font-semibold '> We believe in making things better for everyone, even if just by a little bit! </p>
        </div>
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#fcfae3] p-[1.5rem]">
          <div className="flex items-center gap-3">
            ...
            <p className='text-[13px] text-textColor opacity-[0.7] py-[1rem] font-semibold '> We working on the basis of creating trust which can be nurtured through authenticity</p>
        </div>
