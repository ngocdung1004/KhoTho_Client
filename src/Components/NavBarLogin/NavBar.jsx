...
const NavBar = () => {
  ...
  const handleLogout = () => {
    ...
    navigate("/khotho"); // Điều hướng sau khi đăng xuất
  };
      ...
      <div className="navBarBottom">
        <div className="logoDiv">
          <h1 className="logo text-[25px] text-blueColor logo-flex">
            <Link 
              to="/khotho"  className="flex logoKHOTHO">
        ...
        <div className="menu flex gap-8">
          ...
          {!isLoggedInvalue && (
            <>
              <Link to="/khotho/login" className="menuList text-[#6f6f6f] hover:text-blueColor">
                Đăng nhập
              </Link>
              <Link to="/khotho/register" className="menuList text-[#6f6f6f] hover:text-blueColor">
                Đăng ký
              </Link>
            </>
          )}
