...
const Customer = () => {
  ...
  const usersWithWorkerId2Count = users.filter(user => user.userType === 2).length;
                  ...
                  <div className="flex flex-col flex-1 px-3 mt-6">
                      <div className="space-y-4">
                          ...
                          <nav className="flex-1 space-y-2">
                              ...
                              <a href="#" className="flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 text-gray-900 hover:text-white rounded-lg hover:bg-indigo-600 group">
                                <svg className="flex-shrink-0 w-5 h-5 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <div>
            <Row>
              ...
              {firstUserWithWorkerId0 && (
                <Col xl={6} xxl={4} className= "col-navbar-show-gene-body white-color-sl">
                  <Card className= "navbar-show-gene">
                    <Card.Body className= "navbar-show-gene-body">
                      ...
                      <p className='info-Administrator'>Email: {firstUserWithWorkerId0.email}</p>
                      <p className='info-Administrator'>Phone: {firstUserWithWorkerId0.phoneNumber}</p>
                    </Card.Body>
                  </Card>
                </Col>
              )}
              ...
              <Col xl={6} xxl={4} className='white-color-sl'>
                <Card className= "navbar-show-gene">
                  ...
                  <div className='navbar-show-content'>
                    ...
                    <PeopleAltIcon fontSize="inherit" className='icon-navbar-info' />
                      {totalUsers}
                    </h3>
                  </div>
                  </Card.Body>
                ...
                <Card className= "navbar-show-gene">
                  <Card.Body className='navbar-show-gene-body'>
                    <div className='navbar-show-content'>
                      ...
                      <h3 className="f-w-300">
                      <EngineeringIcon fontSize="inherit" className='icon-navbar-info' />
