        ...
        >
          <Grid item xs={12} sm={12} md={5} component='section'>
            ...
            >
              ...
              <div style={{fontSize: "14px", fontWeight: "300", width: "80%", textAlign: 'justify'}}>Cùng hệ thống tương tác hai chiều, dễ dàng đặt lịch để nhân viên đến hỗ trợ nhanh chóng cho công việc của bạn, hoặc chính bạn sẽ trở thành người làm việc để mang lại những nguồn thu nhập tuyệt vời cho chính bản thân.</div>
            </Typography>
          </Grid>
